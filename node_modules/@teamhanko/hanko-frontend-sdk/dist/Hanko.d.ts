...
import { StateCreateConfig } from "./lib/flow-api/State";
...
declare class Hanko extends Listener {
     ...
     * @subcategory FlowAPI
     */
    createState(flowName: FlowName, config?: StateCreateConfig): Promise<import("./lib/flow-api/types/flow").AnyState>;
    /**
     ...
     */
    validateSession(): Promise<SessionCheckResponse>;
    /**
